---
source: https://obsidian.vip/zh/advanced/regular-expression.html#_29-email-%E6%94%AF%E6%8C%81%E4%B8%AD%E6%96%87%E9%82%AE%E7%AE%B1
author:
  - "[[coffeebean]]"
created: 2025-09-30
tags:
  - clippings
---
[coffeebean](https://obsidian.vip/) 2023年2月7日 大约 5 分钟
...
## 13 数字/货币金额（支持负数、千分位分隔符）

```javascript
/^-?\d{1,3}(,\d{3})*(\.\d{1,2})?$/
```

## 14 银行卡号（10到30位, 覆盖对公/私账户, 参考\[微信支付\]
...
## 18 手机号(mobile phone)中国(严谨), 根据工信部2019年最新公布的手机号段

```javascript
/^(?:(?:\+|00)86)?1(?:(?:3[\d])|(?:4[5-79])|(?:5[0-35-9])|(?:6[5-7])|(?:7[0-8])|(?:8[\d])|(?:9[1589]))\d{8}$/
```

## 19 手机号(mobile phone)中国(宽松), 只要是13,14,15,16,17,18,19开头即可
...
## 22 可以被moment转化成功的时间 YYYYMMDD HH:mm:ss
