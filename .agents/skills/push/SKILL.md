...
2. Run local validation before pushing (e.g., `python -m pytest` or project-specific checks).
...
6. Write/update PR body using the project's PR template if available:
...
7. Validate PR body if project provides a check tool.
...
# Write/edit PR body to match the project's PR template before validation.
