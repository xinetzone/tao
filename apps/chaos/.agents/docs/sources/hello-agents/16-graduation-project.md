---
source: https://github.com/datawhalechina/hello-agents/blob/main/docs/chapter16/第十六章 毕业设计.md
raw_url: https://raw.githubusercontent.com/datawhalechina/hello-agents/main/docs/chapter16/第十六章 毕业设计.md
captured_at: 2026-06-02
capture_tool: github-contents-api
purpose: Hello-Agents 教程章节原始抓取归档，用于追溯结构化萃取页
---
...
- 数据集1: 百度网盘下载链接（提取码: xxxx）
- 数据集2: Google Drive 下载链接
- 演示视频: B站链接 / YouTube 链接
```
