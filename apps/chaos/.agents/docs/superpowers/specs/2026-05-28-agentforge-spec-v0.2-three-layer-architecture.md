...
v0.2 的核心设计决策：**将完整性从"垂直堆叠"改为"正交分层"**。
...
- [ ] 参考实现：一个简单的 Python 项目采用 Layer 1
...
| 版本 | 日期 | 变更 |
|------|------|------|
| v0.2 Draft | 2026-05-28 | 三层分离架构：Layer 1 Project Protocol / Layer 2 Collaboration Protocol / Layer 3 World Runtime；SKILL.md frontmatter 扩展；操作性约束 schema；标准化路径 |
