...
|------|--------|-----------|--------|---------|
| **AgentForge** | 免费（MIT） | — | — | 完全开源，零付费 |
| LangChain | 免费（MIT） | LangSmith $39/月 | 定制定价 | 核心免费+观测付费 |
| CrewAI | 免费（MIT） | AMP $25/月 | 定制定价 | 核心免费+Cloud付费 |
| AutoGen | 免费（MIT） | — | Azure AI Foundry | 核心免费+云服务付费 |
| Dify | 免费（Apache 2.0） | Cloud $59/月 | Team $159/月 | 核心免费+Cloud付费 |
| OpenAI Agents SDK | 免费（Apache 2.0） | — | — | API用量计费 |
