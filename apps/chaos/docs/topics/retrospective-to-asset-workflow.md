...
| 维度 | 评分 | 依据 |
|------|------|------|
| 频率 | 2/3 | 第 1 次：SPA 内容提取（2026-06-21）；第 2 次：微信文章提取（2026-06-24） |
| 普适性 | ✅ | 不依赖个人偏好，跨任务可复用 |
...
> 第 2 次触发记录：[`session-recap-force-conf-20260624.md`](session-recap-force-conf-20260624.md)（2026-06-24，微信文章提取与学习）

---

*版本：v0.2 · 2026-06-24 更新频率至 2/3*
*v0.1 · 2026-06-21 创建*
