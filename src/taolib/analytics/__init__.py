...
使用方式：
    ...
    from taolib.analytics.models import EventCreate, EventType
    from taolib.analytics.services import AnalyticsService
...
from taolib.analytics.errors import (
    AggregationError,
    AnalyticsError,
    AppNotFoundError,
    EventValidationError,
)
from taolib.analytics.models import (
    DeviceType,
    EventBase,
    EventBatchCreate,
    EventCreate,
