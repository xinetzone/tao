...
Example:
    基本使用::
        ...
        from taolib.audit import AuditLogger, InMemoryAuditStorage
    ...
    FastAPI 中间件::
        ...
        from taolib.audit import AuditMiddleware, AuditLogger, InMemoryAuditStorage
    ...
    MongoDB 存储::
        ...
        from taolib.audit import AuditLogger, MongoDBAuditStorage
