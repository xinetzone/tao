...
from taolib.file_storage.models.file import FileMetadataResponse
from taolib.file_storage.models.upload import (
    ChunkRecord,
    UploadSessionCreate,
...
class UploadService:
    ...
    async def complete_upload(
        ...
        # 完成后端分片上传
        from taolib.file_storage.storage.protocols import PartInfo
        ...
        # 通过文件扩展名推断媒体类型
        from taolib.file_storage.processing.validator import (
