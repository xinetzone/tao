...
from taolib.rate_limiter.config import load_rate_limit_config
from taolib.rate_limiter.stats import RateLimitStatsService
from taolib.rate_limiter.store import RedisRateLimitStore
...
def create_app() -> FastAPI:
    ...
    # 注册限流统计路由
    from taolib.rate_limiter.api.router import router as stats_router
