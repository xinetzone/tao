...
async def lifespan(app: FastAPI) -> AsyncGenerator[None]:
    """应用生命周期管理。"""
    from taolib.testing.task_queue.queue.redis_queue import RedisTaskQueue
    from taolib.testing.task_queue.repository.task_repo import TaskRepository
    from taolib.testing.task_queue.worker.manager import WorkerManager
    from taolib.testing.task_queue.worker.registry import get_default_registry
