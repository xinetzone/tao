...
from taolib.file_storage.services.file_service import FileService
from taolib.file_storage.services.lifecycle_service import LifecycleService
from taolib.file_storage.services.stats_service import StatsService
from taolib.file_storage.services.upload_service import UploadService
...
class TestAccessService:
    ...
    def _make_service(self, *, with_cdn=True, secret="test-hmac-secret-key"):
        ...
        from taolib.file_storage.services.access_service import AccessService
    ...
    def test_generate_token_deterministic_with_fixed_time(self):
        ...
        svc, *_ = self._make_service()
        with patch("taolib.file_storage.services.access_service.time") as mock_time:
...
class TestBucketServiceEdgeCases:
    ...
    async def test_update_bucket_not_found(self):
        ...
        from taolib.file_storage.models.bucket import BucketUpdate
