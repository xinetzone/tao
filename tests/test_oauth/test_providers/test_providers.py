...
from taolib.oauth.providers import ProviderRegistry
from taolib.oauth.providers.github import GitHubOAuthProvider
from taolib.oauth.providers.google import GoogleOAuthProvider
