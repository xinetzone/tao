...
from taolib.oauth.crypto.token_encryption import TokenEncryptor
from taolib.oauth.errors import OAuthAlreadyLinkedError, OAuthCannotUnlinkError
from taolib.oauth.models.enums import OAuthConnectionStatus, OAuthProvider
from taolib.oauth.models.profile import OAuthUserInfo
...
from taolib.oauth.services.account_service import OAuthAccountService
from taolib.oauth.services.admin_service import OAuthAdminService
from taolib.oauth.services.session_service import OAuthSessionService
...
class TestAdminService:
    ...
    async def test_create_credential(self, service):
        from taolib.oauth.models.credential import OAuthAppCredentialCreate
