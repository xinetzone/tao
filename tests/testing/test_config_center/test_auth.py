...
from taolib.testing.config_center.models.enums import Environment
from taolib.testing.config_center.server.auth.jwt_handler import (
    create_access_token,
    create_refresh_token,
    decode_token,
    verify_access_token,
)
from taolib.testing.config_center.server.auth.rbac import RBACService
...
class TestJWTHandler:
    ...
    def test_create_access_token(self, jwt_secret: str, jwt_algorithm: str) -> None:
        """测试创建 access token。"""
        with patch("taolib.testing.config_center.server.auth.jwt_handler.settings") as mock_settings:
