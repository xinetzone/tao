"""taolib.testing.site 模块测试 — 模型、服务层、路由集成测试."""
import pytest

# taolib.testing.site 模块当前未集成到 taolib 包中，跳过测试
pytest.importorskip("taolib.testing.site")
...
from taolib.testing.site.md import count_words, estimate_reading_time, render_markdown
from taolib.testing.site.models import (
    AdminUser,
    Category,
)
from taolib.testing.site.services import (
    create_article,
    create_category,
    create_comment,
...
def app():
    ...
    工作线程中也能访问同一个数据库连接。
    """
    import taolib.testing.site.database as db_mod
    ...
    from taolib.testing.site.seed import seed_database
    ...
    from taolib.testing.site.routes.admin import router as admin_router
    from taolib.testing.site.routes.api import router as api_router
    from taolib.testing.site.routes.public import router as public_router
    ...
    async def not_found(request: Request, _exc: Exception):
        from taolib.testing.site.services import get_all_categories as _get_cats
